            ...
            return Card(
              child: InkWell(
                ...
                onTap: () {
                  ...
                  ctrl.selectedRepName.value = rep['fullName'] ?? '';
                  Get.toNamed(AppRoutes.supervisorRepDetail,
                      arguments: rep);
                },
                child: Padding(
                  padding: const EdgeInsets.all(16),
                  child: Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(Formatters.formatCurrency(totalCollected),
